...
class _SearchRemoteDataSource implements SearchRemoteDataSource {
  ...
  @override
  Future<List<SearchDataDto>> get(String keyword) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'q': keyword};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<SearchDataDto>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => SearchDataDto.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
