...
abstract class _Search implements SearchEvent {
  factory _Search(final String keyword) = _$SearchImpl;
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({final List<SearchData> data = const []}) : _data = data;
...
abstract class _Initial implements SearchState {
  const factory _Initial({final List<SearchData> data}) = _$InitialImpl;
